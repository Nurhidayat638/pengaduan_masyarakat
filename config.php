...
function kirim_tanggapan($data){
    ...
    mysqli_query($conn,"UPDATE pengaduan SET 
                    status = 'selesai' 
                    WHERE id_pengaduan = '$id_pengaduan'");

    $query = "INSERT INTO tanggapan VALUES ('','$id_pengaduan','$nik','$tgl_pengaduan','$tanggapan','$id_petugas')";
...
function registrasi($data)
{
    ...
    mysqli_query($conn, "INSERT INTO masyarakat 
                  VALUES
                  ('','$nik','$nama','$username','$password','$telephone')");
    return mysqli_affected_rows($conn);
}


function kirim_pengaduan($data)
{
    global $conn;
    $tgl_pengaduan = date("Y-m-d");
    $nik = $data["nik"];
